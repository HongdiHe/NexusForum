...
import com.hongdi.nexusforum.util.SensitiveFilter;
...
public class DiscussPostService {
    ...
    private static final String REDIS_POST_LIST_KEY = "post:list";
    private static final String REDIS_POST_ROWS_KEY = "post:rows";
        ...
        postListCache=Caffeine.newBuilder()
                ...
                .build(new CacheLoader<String, List<DiscussPost>>() {
                    ...
                    public List<DiscussPost> load(@NonNull String key) throws Exception {
                        ...
                        // 二级缓存：Redis -> MySQL
                        String redisKey = REDIS_POST_LIST_KEY + ":" + offset + ":" + limit;
                        ...
                        redisTemplate.opsForValue().set(redisKey, list, expireSeconds, TimeUnit.SECONDS);
                        return list;
                    }
                });
        ...
        postRowsCache=Caffeine.newBuilder()
                ...
                .build(new CacheLoader<Integer, Integer>() {
                    ...
                    public Integer load(@NonNull Integer key) throws Exception {
                        ...
                        // 二级缓存：Redis -> MySQL
                        String redisKey = REDIS_POST_ROWS_KEY + ":" + key;
