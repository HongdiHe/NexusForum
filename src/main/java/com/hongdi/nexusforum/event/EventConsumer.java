...
import com.hongdi.nexusforum.service.ElasticsearchService;
import com.hongdi.nexusforum.service.MessageService;
...
public class EventConsumer implements CommunityConstant {
    ...
    public void handleCommentMessage(ConsumerRecord record) {
        ...
        Event event;
        try {
            event = objectMapper.readValue(record.value().toString(), Event.class);
        } catch (Exception e) {
    ...
    public void handleShareMessage(ConsumerRecord record) {
        ...
        try {
            ...
            logger.error("进程被中断: " + e.getMessage());
            ...
            if (file.exists()) {
                ...
                try {
                    ...
                    Map<String, Object> json = objectMapper.readValue(
                            response.bodyString(), new TypeReference<Map<String, Object>>() {});
